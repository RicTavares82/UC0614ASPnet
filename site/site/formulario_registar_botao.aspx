<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="formulario_registar_botao.aspx.cs" Inherits="site.registar" %>
...
<div class="container-fluid">
                ...
                <div>
                    <div class="col-md-6">
                        ...
                        <div class="form-group">
                            ...
                            <asp:TextBox runat="server" ID="tb_nome" Class="form-control" placeholder="Nome"></asp:TextBox>
                        </div>
                        <div class="row">
                            <div class="col-md-6">
                    ...
                    <div class="col-md-12">
                        ...
                        <asp:Button runat="server" ID="btn_enviar" Text="Enviar" Class="btn btn-warning" OnClick="btn_enviar_Click2" />
                    </div>
        ...
        <br/>
        <br/>
        <div class="footer">Concurso @2025</div>
    </div>
