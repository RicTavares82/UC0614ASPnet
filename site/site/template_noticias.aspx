<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="template_noticias.aspx.cs" Inherits="site.template_noticias2" %>
...
<body>
    <form id="form1" runat="server">
        ...
        <!-- Header End -->
         ...
         <asp:Xml ID="Xml2" runat="server" TransformSource="~/formata_template_noticias.xslt"></asp:Xml>
       ...
       <div class="cat-news">
            <div class="container-fluid">
                <div class="row">
                    ...
                    <asp:Xml ID="Xml3" runat="server" TransformSource="~/formata_template_noticias2.xslt"></asp:Xml>
                                ...
                                <div class="cn-img">
                                    ...
                                    <div class="cn-content">
                                        <div class="cn-content-inner">
                                            <a class="cn-date" href="" dir="ltr"><i class="far fa-clock"></i>05-feb-2020</a>
